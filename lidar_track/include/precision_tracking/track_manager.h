...
const int FRAME_SERIALIZATION_VERSION = 0;
  ...
  public:
    ...
    Frame(pcl::PointCloud<pcl::PointXYZI>::Ptr cloud, double timestamp);
  ...
  public:
    ...
    void insertFrame(pcl::PointCloud<pcl::PointXYZI>::Ptr cloud,
             double timestamp);
  ...
  void serializePointCloud(
      const pcl::PointCloud<pcl::PointXYZI> cloud, std::ostream& out);
