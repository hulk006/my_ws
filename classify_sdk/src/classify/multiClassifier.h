...
{
public:
    MultiClassifier(const std::string& modelfile,  const std::string& rangefile);
    MultiClassifier();
    ~MultiClassifier(){}
    void Classify(const std::vector<pcl::PointCloud<pcl::PointXYZI> >& vec, std::vector<double>& probvec,std::vector<double>& labelvec);
...
private:
    ...
    double objectClassify(const pcl::PointCloud<pcl::PointXYZI>::Ptr& cloud, vector<double>& prob);
    double objectClassify(std::vector<double>& feature, vector<double>& prob);
    void rerangeFeature(std::vector<double> &feature);
    void setSelectfeature(std::vector<int> sf);
    void saveModelToFile(const std::string& modelfile,  const std::string& rangefile);
