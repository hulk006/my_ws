...
public:
  ...
  float v_absolute_; // The target's velocity absolute.(m/s)
...
private:
  ...
  */
  ...
  unsigned int TRACKING_VANISH_TIME_; // The vanish time to determine whether the target disappear or not.
};
